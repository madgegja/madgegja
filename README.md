...
<table>
  <tr>
    ...
    <td align="center" width="50%">
      ...
      10개 마켓 · 874 tests · Phase 1 Draft+Review 구현 완료
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
...
- CS AI Dashboard — Zendesk 실시간 연동, AI Draft 엔진, 874 tests
...
**기술 스택**: FastAPI · Vanilla JS SPA · Zendesk REST API · Claude API (SDK + Proxy) · RAG (섹션 기반, 벡터DB 불필요) · Pydantic v2 · pytest (874건) · CI/CD GitHub Actions
...
- 874 tests 전체 통과 · CI/CD GitHub Actions Test Gate
